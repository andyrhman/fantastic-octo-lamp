        ...
        <div class="ans ml-2">
            ...
            <?php 
                if (strpos($opt1, 'images/') != false) {
                    ...
                    ?>
                    <img src="../blog/admin/quiz/<?php echo $opt1?>" class="my-3" alt="" height="80" width="80">
        ...
        <div class="ans ml-2">
            ...
            <?php 
                if (strpos($opt2, 'images/') != false) {
                    ...
                    ?>
                        <img src="../blog/admin/quiz/<?php echo $opt2?>" class="my-3" alt="" height="80" width="80">
                    <?php
        ...
        <div class="ans ml-2">
            ...
            <?php 
                if (strpos($opt3, 'images/') != false) {
                    ...
                    ?>
                        <img src="../blog/admin/quiz/<?php echo $opt3?>" class="my-3" alt="" height="80" width="80">
                    <?php
        ...
        <div class="ans ml-2">
            ...
            <?php 
                if (strpos($opt4, 'images/') != false) {
                    ...
                    ?>
                        <img src="../blog/admin/quiz/<?php echo $opt4?>" class="my-3" alt="" height="80" width="80">
                    <?php
